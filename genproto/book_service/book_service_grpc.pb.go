...
type BookServiceClient interface {
	...
	GetByID(ctx context.Context, in *BookPrimaryKey, opts ...grpc.CallOption) (*Book, error)
	GetList(ctx context.Context, in *GetListBookRequest, opts ...grpc.CallOption) (*GetListBookResponse, error)
	...
	Delete(ctx context.Context, in *BookPrimaryKey, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *bookServiceClient) GetByID(ctx context.Context, in *BookPrimaryKey, opts ...grpc.CallOption) (*Book, error) {
	out := new(Book)
...
func (c *bookServiceClient) GetList(ctx context.Context, in *GetListBookRequest, opts ...grpc.CallOption) (*GetListBookResponse, error) {
	out := new(GetListBookResponse)
...
func (c *bookServiceClient) Delete(ctx context.Context, in *BookPrimaryKey, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type BookServiceServer interface {
	...
	GetByID(context.Context, *BookPrimaryKey) (*Book, error)
	GetList(context.Context, *GetListBookRequest) (*GetListBookResponse, error)
	Update(context.Context, *UpdateBook) (*Book, error)
	UpdatePatch(context.Context, *UpdatePatchBook) (*Book, error)
	Delete(context.Context, *BookPrimaryKey) (*emptypb.Empty, error)
...
func (UnimplementedBookServiceServer) GetByID(context.Context, *BookPrimaryKey) (*Book, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByID not implemented")
}
func (UnimplementedBookServiceServer) GetList(context.Context, *GetListBookRequest) (*GetListBookResponse, error) {
...
func (UnimplementedBookServiceServer) Delete(context.Context, *BookPrimaryKey) (*emptypb.Empty, error) {
...
func _BookService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).GetByID(ctx, req.(*BookPrimaryKey))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BookService_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).GetList(ctx, req.(*GetListBookRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BookService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).Delete(ctx, req.(*BookPrimaryKey))
	}
	return interceptor(ctx, in, info, handler)
}
